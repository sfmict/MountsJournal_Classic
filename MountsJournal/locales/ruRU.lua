...
L["Speed display"] = "Отображение скорости"
L["Buttons"] = "Кнопки"
L["PANEL_UP"] = "Сверху"
L["PANEL_DOWN"] = "Снизу"
L["PANEL_LEFT"] = "Слева"
L["PANEL_RIGHT"] = "Справа"
...
L["CLASS_MOUNT_HINT"] = "%s или %s - для призыва маунтов в бою (исключая дополнительных)"
L["CLASS_DMOUNT_HINT"] = "%s или %s - для спешивания"
...
L["Spell is usable"] = "Заклинание можно использовать"
...
L["The player is resting"] = "Игрок отдыхает"
L["The player is in combat"] = "Игрок в бою"
L["Sex"] = "Пол"
...
L["Random Mount by Summon Counter"] = "Случайный маунт по счетчику вызовов"
L["Random Mount of Selected Type by Summon Counter"] = "Случайный маунт выбранного типа по счетчику вызовов"
L["The lower the counter, the higher the chance"] = "Меньше счетчик, выше шанс"
L["Mount"] = "Маунт"
...
L["Select all filtered mounts"] = "Выбрать всех отфильтрованных маунтов"
L["Unselect all filtered mounts"] = "Отменить выбор всех отфильтрованных маунтов"
L["Select all favorite mounts"] = "Выбрать всех избранных маунтов"
L["Unselect all favorite mounts"] = "Отменить выбор всех избранных маунтов"
L["Select all mounts"] = "Выбрать всех маунтов"
