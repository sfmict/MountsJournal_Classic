...
do
	...
	local function copyBox_Hide(self)
		self:Hide()
	...
	copyBox:SetScript("OnEditFocusLost", copyBox_Hide)
	copyBox:SetScript("OnEscapePressed", copyBox_Hide)
	...
	copyBox:SetScript("OnEvent", function(self)
		if not self:IsMouseOver() then
			self:ClearFocus()
		end
	end)
	copyBox:SetScript("OnShow", function(self)
	...
	cover:SetScript("OnClick", function(self)
		...
		copyBox:SetPoint("BOTTOMRIGHT", self.fontString, 2, 0)
