...
function journal:updateMountsList()
	...
	local filters, tags, pets, getMountInfo, getMountInfoExtra = mounts.filters, self.tags, ns.pets, util.getMountInfo, util.getMountInfoExtra
	...
	for i = 1, #self.mountIDs do
		...
		local expansion, familyID, _,_, sourceText, isSelfMount, mountType = getMountInfoExtra(mountID)
