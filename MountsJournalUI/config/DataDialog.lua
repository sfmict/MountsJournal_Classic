...
dataDialog:HookScript("OnShow", function(self)
	...
	self.closeBg = self:CreateTexture(nil, "BACKGROUND", nil, -7)
	self.closeBg:SetSize(20, 20)
	self.closeBg:SetPoint("TOPRIGHT", -2, -2)
	self.closeBg:SetTexture("Interface\\FrameGeneral\\UI-Background-Rock")
